...
<img src="<?php echo get_field('immagine_slide1'); ?>" alt="We Create Delicious Memories " title="#slidecaption1" /><img src="<?php echo get_template_directory_uri(); ?>/images/slides/slider2.jpg" alt="Candle Ready Cakes " title="#slidecaption2" /><img src="<?php echo get_template_directory_uri(); ?>/images/slides/slider3.jpg" alt="Delicious Cookies " title="#slidecaption3" /></div>                    
                <div id="slidecaption1" class="nivo-html-caption">
                    ...
                    <div id="slidecaption2" class="nivo-html-caption">
                    <div class="slide_info">
                            <h2><?php echo get_field('titolo_slide2'); ?></h2>
                            <p><?php echo get_field('testo_slide2');;?></p>
                            <div class="clear"></div>
                            <!--<a class="ReadMore" href="#link2"><?php echo 'Read More'; ?></a>-->
                      </div>
                    </div>
                    <div id="slidecaption3" class="nivo-html-caption">
                      <div class="slide_info">
                            <h2><?php echo get_field('titolo_slide3');?></h2>
                            <p><?php echo get_field('testo_slide3'); ?> </p>
                            <div class="clear"></div>
                            <!--<a class="ReadMore" href="#link3"><?php echo 'Read More'; ?></a>-->
                    </div>
                   </div>
